  ...
  ###################################################################################  
    ...
    setPositionOnBoard(sign, x,y) {
        ...
        for(let i = 0; i < this.feld.length; i++) {
            if(i == p) feld1 = feld1.concat(sign);
            else feld1 = feld1.concat(this.feld[i]);
        }
        //console.log(feld1);
        //return feld1;
        this.feld = feld1;
    ...
    isOnBoard(pos : Position) {
        if(pos.x > 0 && pos.y > 0 && pos.x < this.feld_length && pos.y < this.feld_height) return true;
    }
