...
//  x = -1 0 1
      ...
      x = 0, y = 0
      const threshold = 0.1;
      if(output[3] > threshold && output[3] > output[5]) x = -1 // to the left
      if(output[5] > threshold && output[5] > output[3]) x = 1 // to the right
      if(output[1] > threshold && output[1] > output[7]) y = -1 // up
      if(output[7] > threshold && output[7] > output[1]) y = 1 // down
