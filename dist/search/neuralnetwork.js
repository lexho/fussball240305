...
export class NeuralNetworkSearch extends Search {
    constructor(limit) {
        ...
        this.FACTOR = 16;
        this.IN = this.board.feld.feld_length * this.board.feld.feld_height / this.FACTOR;
        this.HIDDEN = Math.round(this.board.feld.feld_length * this.board.feld.feld_height / this.FACTOR / 3);
